        ...
        <div class="col">
            <form action="<?= base_url('/komik/update/' . $komik['id']); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= (strlen(strip_tags(validation_show_error('judul')))) ? 'is-invalid' : $set; ?>" id="judul" name="judul" autofocus value="<?= (old('judul')) ? old('judul') : $komik['judul'] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control  <?= (strlen(strip_tags(validation_show_error('penulis')))) ? 'is-invalid' : $set; ?>" id="penulis" name="penulis" value="<?= (old('penulis')) ? old('penulis') : $komik['penulis'] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= (strlen(strip_tags(validation_show_error('penerbit')))) ? 'is-invalid' : $set; ?>" id="penerbit" name="penerbit" value="<?= (old('penerbit')) ? old('penerbit') : $komik['penerbit'] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <label class="custom-file-label"><?= $komik['sampul']; ?></label>
                    </div>
                    <div class="col-sm-8">
